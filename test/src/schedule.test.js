    ...
    describe('when given a schedule for a restaurant', () => {
      ...
      describe('is open past midnight', () => {
        it('should create openings on both days', () => {
          const master = {}
          insertSchedule(master, 'Thai Stick Restaurant', ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'], {
            start: 11 * 60,
            stop: 24 * 60,
            spillOver: 60,
          })
      ...
      describe('is closed early and late', () => {
        it('should create just oneopenings on the day', () => {
          const master = {}
          insertSchedule(master, 'Chili Lemon Garlic', ['Mon', 'Tue', 'Wed', 'Thu', 'Fri'], {
            start: 11 * 60,
            stop: 22 * 60,
            spillOver: 0,
          })
